$(document).ready(function() {
  ...
  var cities = [
    "Charlotte", "New York", "Washington DC",
  ...
  var languages = [
    "ActionScript", "AppleScript", "Asp", "Bash",
    "C", "C#", "C++", "Clojure", "CoffeeScript",
    "D", "Dart", "Delphi", "Go", "Haskell",
    "Java", "JavaScript", "Julia", "Kotlin",
    "Lisp", "Lua", "Objective-C", "Perl",
    "PHP", "Python", "R", "Ruby",
    "Rust", "Scala", "Swift", "TypeScript"
  ];
  $("#language").autocomplete({ source: languages, minLength: 1 });
